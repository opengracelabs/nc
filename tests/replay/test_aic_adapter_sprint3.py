...
async def test_aic_sprint3_replay_writes_la_grande_jatte_full_m36_path() -> None:
    conn = ReplayConn()
...
async def test_aic_sprint3_replay_blocks_no_image_id_without_store_write_path() -> None:
    conn = ReplayConn()
