...
async def test_yale_sprint3_compliance_allowed_record_writes_all_m36_tables_and_pins() -> None:
    conn = ReplayConn()
...
async def test_yale_sprint3_compliance_blocked_record_has_zero_writes() -> None:
    conn = ReplayConn()
...
async def test_yale_sprint3_compliance_missing_object_has_zero_writes() -> None:
    conn = ReplayConn()
