"""Shared technical metadata extraction for M36 media adapters."""
...
from .contracts import NormalizedMediaRecord, mandatory_field_warnings
...
def build_technical_metadata(
    normalized: NormalizedMediaRecord,
    *,
    media_type_id: str,
    source_slug: str,
    schema_standard: str = "edm",
    mandatory_warnings: Callable[[NormalizedMediaRecord], list[str]] = mandatory_field_warnings,
) -> dict[str, Any]:
    """Build media_technical_metadata.content for a normalized media record."""
    ...
    content = {
        ...
        "mandatory_field_warnings": mandatory_warnings(normalized),
    }
